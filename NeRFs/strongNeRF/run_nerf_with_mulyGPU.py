from load_data import load_audface_data
import os
import sys
import numpy as np
import imageio
...
os.environ["CUDA_VISIBLE_DEVICES"] = "2,3,4,5"  # CUDA_VISIBLE_DEVICES 表当前可被python程序检测到的显卡
dist_backend = 'nccl'
...
def create_nerf(args):
    ...
    #model = model.cuda(device=device_ids[0])  #模型加载的device0
...
def config_parser():
    ...
    parser.add_argument("--datadir", type=str, default='/home/zyh/speedtalker/mask_basedNeRF/dataset',
    ...
    parser.add_argument("--N_rand", type=int, default=2048*4,
    ...
    parser.add_argument("--ft_path", type=str, default="/home/zyh/speedtalker/mask_basedNeRF/pretrained_model/300000_head.tar",
...
if __name__ == '__main__':
    ...
    print("visable GPU:", torch.cuda.device_count())
    train()